...
GO
ALTER INDEX [XMLPATH_Individual_Demographics]
    ON [Sales].[Individual] DISABLE;
...
GO
ALTER INDEX [XMLPROPERTY_Individual_Demographics]
    ON [Sales].[Individual] DISABLE;
...
GO
ALTER INDEX [XMLVALUE_Individual_Demographics]
    ON [Sales].[Individual] DISABLE;
